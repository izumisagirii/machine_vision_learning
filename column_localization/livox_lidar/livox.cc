    ...
    if (eth_packet) {
        ...
        if (data->data_type == kCartesian) {
            for (size_t i = 0; i < data_num; i++) {
                ...
                lidar_this->cloud->points[num] = point;
                num++;
                num = num % lidar_this->max_cloud_size;
            }
            ...
            for (size_t i = 0; i < data_num; i++) {
                ...
                point.x = p_point_data->x1;
                point.y = p_point_data->y1;
                point.z = p_point_data->z1;
                lidar_this->cloud->points[num] = point;
                num++;
                num = num % lidar_this->max_cloud_size;
                point.x = p_point_data->x2;
                point.y = p_point_data->y2;
                point.z = p_point_data->z2;
                lidar_this->cloud->points[num] = point;
                num++;
                num = num % lidar_this->max_cloud_size;
            }
